...
class TestSmokeside():
  ...
  def test_smokeside(self):
    ...
    self.driver.set_window_size(1470, 856)
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("cavalcanti")
    self.driver.find_element(By.NAME, "bizname").send_keys("any")
    self.driver.find_element(By.NAME, "biztitle").send_keys("any")
    ...
    self.driver.find_element(By.ID, "password").send_keys("adm")
